...
export const useRevokeProjectProviderAccessApiV1ProjectsProjectIdProviderAccessProviderIdDelete = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    export type listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetResponse200 = {
  data: ProjectSubscriptionAccessResponse[]
  status: 200
}

export type listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetResponseSuccess = (listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetResponse200) & {
  headers: Headers;
};
export type listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetResponseError = (listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetResponse422) & {
  headers: Headers;
};

export type listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetResponse = (listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetResponseSuccess | listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetResponseError)

export const getListProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetUrl = (projectId: string,) => {




  return `/api/v1/projects/${projectId}/subscription-access`
}

/**
 * @summary List Project Subscription Access
 */
export const listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet = async (projectId: string, options?: RequestInit): Promise<listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetResponse> => {

  return apiMutator<listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetResponse>(getListProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetUrl(projectId),
  {
    ...options,
    method: 'GET'
...
export const getListProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetQueryKey = (projectId: string,) => {
    return [
    `/api/v1/projects/${projectId}/subscription-access`
    ] as const;
    }


export const getListProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetQueryOptions = <TData = Awaited<ReturnType<typeof listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet>>, TError = HTTPValidationError>(projectId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetQueryKey(projectId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet>>> = ({ signal }) => listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet(projectId, { signal });





   return  { queryKey, queryFn, enabled: !!(projectId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type ListProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetQueryResult = NonNullable<Awaited<ReturnType<typeof listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet>>>
export type ListProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetQueryError = HTTPValidationError


export function useListProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet<TData = Awaited<ReturnType<typeof listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet>>, TError = HTTPValidationError>(
 projectId: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet>>,
          TError,
          Awaited<ReturnType<typeof listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet>>
        > , 'initialData'
      >, }
...
export function useListProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet<TData = Awaited<ReturnType<typeof listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet>>, TError = HTTPValidationError>(
 projectId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary List Project Subscription Access
...
export function useListProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet<TData = Awaited<ReturnType<typeof listProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGet>>, TError = HTTPValidationError>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getListProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessGetQueryOptions(projectId,options)
...
export type grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostResponse201 = {
  data: ProjectSubscriptionAccessResponse
  status: 201
}

export type grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostResponseSuccess = (grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostResponse201) & {
  headers: Headers;
};
export type grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostResponseError = (grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostResponse422) & {
  headers: Headers;
};

export type grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostResponse = (grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostResponseSuccess | grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostResponseError)

export const getGrantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostUrl = (projectId: string,) => {
...
/**
 * @summary Grant Project Subscription Access
 */
export const grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPost = async (projectId: string,
    grantProjectSubscriptionAccessRequest: GrantProjectSubscriptionAccessRequest, options?: RequestInit): Promise<grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostResponse> => {

  return apiMutator<grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostResponse>(getGrantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostUrl(projectId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getGrantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPost>>, TError,{projectId: string;data: GrantProjectSubscriptionAccessRequest}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPost>>, TError,{projectId: string;data: GrantProjectSubscriptionAccessRequest}, TContext> => {

const mutationKey = ['grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPost'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPost>>, {projectId: string;data: GrantProjectSubscriptionAccessRequest}> = (props) => {
          const {projectId,data} = props ?? {};

          return  grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPost(projectId,data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GrantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostMutationResult = NonNullable<Awaited<ReturnType<typeof grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPost>>>
    export type GrantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostMutationBody = GrantProjectSubscriptionAccessRequest
    export type GrantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostMutationError = HTTPValidationError

    /**
 * @summary Grant Project Subscription Access
 */
export const useGrantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPost = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPost>>, TError,{projectId: string;data: GrantProjectSubscriptionAccessRequest}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof grantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPost>>,
        TError,
        {projectId: string;data: GrantProjectSubscriptionAccessRequest},
        TContext
      > => {
      return useMutation(getGrantProjectSubscriptionAccessApiV1ProjectsProjectIdSubscriptionAccessPostMutationOptions(options), queryClient);
    }
