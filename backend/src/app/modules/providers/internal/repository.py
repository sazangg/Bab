...
async def create_model_offering(
    *,
    ...
    catalog_input_price_per_million_tokens: int | None = None,
    catalog_output_price_per_million_tokens: int | None = None,
    catalog_cached_input_price_per_million_tokens: int | None = None,
    pricing_catalog_version: str | None = None,
    pricing_last_refreshed_at=None,
    ...
    model_offering = ModelOffering(
        ...
        catalog_input_price_per_million_tokens=catalog_input_price_per_million_tokens,
        catalog_output_price_per_million_tokens=catalog_output_price_per_million_tokens,
        catalog_cached_input_price_per_million_tokens=catalog_cached_input_price_per_million_tokens,
        pricing_catalog_version=pricing_catalog_version,
        pricing_last_refreshed_at=pricing_last_refreshed_at,
